...
- (void)setManagedObjectContext:(NSManagedObjectContext *)managedObjectContext
{
    ...
    NSFetchRequest *requset = [NSFetchRequest fetchRequestWithEntityName:@"Photographer"];
    requset.predicate = nil;
    requset.sortDescriptors = @[[NSSortDescriptor sortDescriptorWithKey:@"name" ascending:YES selector:@selector(localizedStandardCompare:)]];
    
    //requset.fetchLimit = 100;
    
    
    self.fetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:requset managedObjectContext:managedObjectContext sectionNameKeyPath:nil cacheName:nil];
}
